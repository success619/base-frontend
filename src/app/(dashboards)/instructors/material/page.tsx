...
export default function InstructorHubPage() {
  ...
  const totalPublished = INITIAL_COURSE_DATA.reduce(
    (acc, curr) => acc + curr.published,
    0,
  );
  const activeDrafts = INITIAL_COURSE_DATA.reduce(
    (acc, curr) => acc + curr.drafts,
    0,
  );
  ...
  return (
    <main className="min-h-screen bg-gray-800 rounded-2xl text-white p-6 md:p-12 pt-20">
      <div className="max-w-7xl mx-auto">
        <Link
          href="/instructors"
          className="flex items-center gap-2 text-gray-500 hover:text-[#035b77] mb-8 group transition-colors"
        >
          <ArrowLeft
            size={18}
        ...
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 border-l-4 border-[#035b77] pl-6">
          ...
          <div className="flex gap-8 border-t md:border-t-0 md:border-l border-gray-800 pt-6 md:pt-0 md:pl-8">
            <div className="text-center">
              ...
              <p className="text-2xl font-black text-[#035b77]">
                {totalPublished}
              </p>
            </div>
            <div className="text-center">
              ...
              return (
                ...
                >
                  <div className="p-7">
                    ...
                    <p className="text-[10px] font-bold text-gray-500 uppercase mb-6 line-clamp-1">
                      {course.title}
                    </p>
                    ...
                    <button
                      onClick={() =>
                        router.push(`/instructors/material/${course.course_id}`)
                      }
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <PlusCircle
                          size={14}
                          className="text-[#035b77] group-hover/btn:scale-110 transition-transform"
                        />
                      ...
                      <ChevronRight
                        size={14}
                        className="text-gray-700 group-hover/btn:text-[#035b77] group-hover/btn:translate-x-1 transition-all"
                      />
                    </button>
                  </div>
                </motion.div>
